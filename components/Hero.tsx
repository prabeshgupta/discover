                ...
                <div className='mt-[25px] z-10'>
                    ...
                    <div className='mt-[40px] flex justify-center items-center gap-3 z-20'>
                        <input type="text" placeholder='Search your location...'
                            className='z-10 bg-white p-3 border-[1.2px] rounded-full px-4 w-[36%] shadow-sm outline-purple-500' onChange={(e) => setSearchInput(e.target.value)} />
                        <button className='bg-gradient-to-l from-indigo-500 via-purple-500 to-pink-500 rounded-full p-3 shadow-md z-10 cursor-pointer hover:scale-105 transition-all'
