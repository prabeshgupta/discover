...
const SideDrawer = ({ place, close }: any) => {
    ...
    return (
        <div className='h-screen w-screen md:w-[400px] bg-white shadow-md p-5 z-20'>
            ...
            <div>
                <h2 className='line-clip-2 text-[20px] font-semibold mb-3'>{place.name}</h2>
                {place?.photos ? <Image src={BASE_URL_PHOTO +
                    "&photo_reference=" + place?.photos[0]?.photo_reference +
                    "&key=" + process.env.NEXT_PUBLIC_GOOGLE_PLACES_KEY} alt='placeholder'
                    width={200} height={80}
             ...
             text-gray-600 line-clamp-2'>{place.formatted_address}</h2>
                </div>
                ...
                <div className='flex gap-2 mt-3'>
                    ...
                    <h2 className='text-[14px]
             text-gray-600 line-clamp-2 tracking-wider'>{place.rating} ({place.user_ratings_total})</h2>
                </div>
